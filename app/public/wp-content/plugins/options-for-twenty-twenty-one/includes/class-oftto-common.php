	...
	class ofttoCommon {
        ...
        public static function plugin_row_meta($plugin_meta, $plugin_file, $plugin_data, $status) {
            ...
            if ($plugin_file === self::$plugin_text_domain . '/' . self::$plugin_text_domain . '.php') {
                ...
                $plugin_meta[] = '<a href="https://wordpress.org/support/plugin/' . self::$plugin_text_domain . '/reviews/?filter=5#new-post" title="' . addslashes(sprintf(__('If you like %s, please leave a review!', self::$plugin_text_domain), self::$plugin_name)) . '">' . __('Review plugin', self::$plugin_text_domain) . '</a>';
...
<p><a href="<?= self::premium_link(); ?>" title="<?= addslashes(sprintf(__('Download %s Premium', self::$plugin_text_domain), self::$plugin_name)); ?>" class="button-primary"><?= sprintf(__('Download %s Premium', self::$plugin_text_domain), self::$plugin_name); ?></a></p>
...
<a href="<?= self::premium_link(); ?>" title="<?= addslashes(sprintf(__('Try %s Premium', self::$plugin_text_domain), self::$plugin_name)); ?>" class="button-primary"><?= sprintf(__('Trial %s Premium for 7 days', self::$plugin_text_domain), self::$plugin_name); ?></a>
...
?>
<a href="<?= self::upgrade_link(); ?>" title="<?= addslashes(sprintf(__('Upgrade now to %s Premium', self::$plugin_text_domain), self::$plugin_name)); ?>" class="button-primary"><?= sprintf(__('Upgrade now to %s Premium', self::$plugin_text_domain), self::$plugin_name); ?></a></p>
...
?>
<p><?= __('Funding plugins like this one with small financial contributions is essential to pay the developers to continue to do what they do. Please take a moment to give a small amount ...', self::$plugin_text_domain); ?></p>
<p><a href="<?= self::upgrade_link(); ?>" title="<?= addslashes(sprintf(__('Contribute to %s', self::$plugin_text_domain), self::$plugin_name)); ?>" class="button-primary"><?= sprintf(__('Contribute to %s', self::$plugin_text_domain), self::$plugin_name); ?></a> <a href="#" id="<?= self::$plugin_prefix; ?>-already-paid" title="<?= addslashes(__('Aleady Contributed!', self::$plugin_text_domain)); ?>" class="button-primary"><?= __('Aleady Contributed!', self::$plugin_text_domain); ?></a></p>
</div>

<script type="text/javascript">
    jQuery(document).on('click', '#<?= self::$plugin_prefix; ?>-already-paid', function() {
        if (confirm(<?= json_encode(__('Have you really? Press "Cancel" if you forgot to 🙂', self::$plugin_text_domain)); ?>)) {
